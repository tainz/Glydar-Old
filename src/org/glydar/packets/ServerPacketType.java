...
public enum ServerPacketType {
	...
	EntityUpdate(0), MultipleEntityUpdate(1), UpdateFinished(2), Unknown3(3), Unknown4(
			4), CurrentTime(5), ServerChatMessage(10), SeedData(15), ServerData(
			16), ServerMismatch(17), ServerFull(18);
