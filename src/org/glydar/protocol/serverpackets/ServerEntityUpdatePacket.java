...
public class ServerEntityUpdatePacket extends StructuredPacket {
	...
	static {
		...
		structure2.addDataType(new PacketDataType(Vec3.class)); // extra
																// velocity
		structure2.addDataType(new PacketDataType(Float.class)); // look pitch
		structure2.addDataType(new PacketDataType(Integer.class)); // physics
																	// flags
		...
		structure2.addDataType(new PacketDataType(Integer.class)); // entity
																	// type
		structure2.addDataType(new PacketDataType(Byte.class)); // current mode
		structure2.addDataType(new PacketDataType(Byte.class, 3)); // skip
		structure2.addDataType(new PacketDataType(Integer.class)); // last shoot
																	// time
		structure2.addDataType(new PacketDataType(Integer.class)); // hit
																	// counter
		structure2.addDataType(new PacketDataType(Integer.class)); // last hit
																	// time
		...
		structure2.addDataType(new PacketDataType(Byte.class)); // movement
																// flags
		...
		structure2.addDataType(new PacketDataType(Float.class)); // bounding
																	// radius
		structure2.addDataType(new PacketDataType(Float.class)); // bounding
																	// height
		...
		structure2.addDataType(new PacketDataType(Short.class)); // shoulder
																	// model
		...
		structure2.addDataType(new PacketDataType(Float.class)); // shoulder
																	// scale
		...
		structure2.addDataType(new PacketDataType(Integer.class)); // slowed
																	// time
		structure2.addDataType(new PacketDataType(Integer.class)); // make blue
																	// time
		structure2.addDataType(new PacketDataType(Integer.class)); // speed up
																	// time
		structure2.addDataType(new PacketDataType(Float.class)); // show patch
																	// time
		...
		structure2.addDataType(new PacketDataType(Float.class)); // max hp
																	// multiplier
		structure2.addDataType(new PacketDataType(Float.class)); // shoot speed
		structure2.addDataType(new PacketDataType(Float.class)); // damage
																	// multiplier
		structure2.addDataType(new PacketDataType(Float.class)); // armor
																	// multiplier
		structure2.addDataType(new PacketDataType(Float.class)); // resi
																	// multiplier
		...
		structure2.addDataType(new PacketDataType(Byte.class, 2)); // skip
		structure2.addDataType(new PacketDataType(Integer.class)); // character
																	// level
		...
		structure2.addDataType(new PacketDataType(Integer.class)); // unknown/not
																	// used 1
		structure2.addDataType(new PacketDataType(Integer.class)); // unknown/not
																	// used 2
		structure2.addDataType(new PacketDataType(Byte.class)); // unknown/not
																// used 3
		structure2.addDataType(new PacketDataType(Byte.class, 3)); // skip
		structure2.addDataType(new PacketDataType(Integer.class)); // unknown/not
																	// used 4
		structure2.addDataType(new PacketDataType(Integer.class)); // unknown/not
																	// used 5
		structure2.addDataType(new PacketDataType(Integer.class)); // not used
																	// 11
		structure2.addDataType(new PacketDataType(Integer.class)); // not used
																	// 12
		...
		structure2.addDataType(new PacketDataType(Integer.class)); // minus
																	// modifier
		...
		structure2.addDataType(new PacketDataType(Integer.class)); // upgrade
																	// count
		// end item data
		...
		nameIndex = structure2
				.addDataType(new PacketDataType(String.class, 16)); // name
	...
	public ServerEntityUpdatePacket compress() throws Exception {
		...
		spd.setDataAtStructureIndex(1, 0,
				ZLibUtil.compress(spd.getDataAtStructure(1)));
	...
	public ServerEntityUpdatePacket setData(String name) throws Exception {
		...
		spd.setDataAtIndex(nameIndex,
				name.getBytes(Charset.forName("UTF-16LE")));
